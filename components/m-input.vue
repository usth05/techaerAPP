<template>
	<view class="m-input-view">
		...
		<!-- <view v-if="clearable_&&!displayable_&&value.length" class="m-input-icon">
			<m-icon color="#666666" type="guanbi" size="20" @click="clear"></m-icon>
		</view>
		<view v-if="displayable_" class="m-input-icon">
			<m-icon :color="showPassword?'#666666':'#cccccc'" type="liulan" size="20" @click="display"></m-icon>
		</view> -->
		<input :focus="focus_" type="text">
	</view>
</template>
